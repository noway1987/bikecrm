...
@InputType()
class AppointmentCreateNestedManyWithoutCustomersInput {
...
export { AppointmentCreateNestedManyWithoutCustomersInput as AppointmentCreateNestedManyWithoutCustomersInput };
